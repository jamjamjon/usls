...
impl Color {
    ...
    pub fn palette_coco_80() -> Vec<Self> {
        Self::create_palette(&[
            0xFF3838FF, 0xFF9D97FF, 0xFF701FFF, 0xFFB21DFF, 0xCFD231FF, 0x48F90AFF, 0x92CC17FF,
            0x3DDB86FF, 0x1A9334FF, 0x00D4BBFF, 0x2C99A8FF, 0x00C2FFFF, 0x344593FF, 0x6473FFFF,
            0x0018ECFF, 0x8438FFFF, 0x520085FF, 0xCB38FFFF, 0xFF95C8FF, 0xFF37C7FF, 0xD7D7D7FF,
            0xC8FF00FF, 0xC8D200FF, 0x5CFF00FF, 0x00FF0DFF, 0x00FF94FF, 0x00FFD5FF, 0x00D5FFFF,
            0x0095FFFF, 0x0045FFFF, 0x3000FFFF, 0x8400FFFF, 0xCB00FFFF, 0xFF00ECFF, 0xFF0094FF,
            0xFF0064FF, 0xFF3C00FF, 0xFF6400FF, 0xFFA000FF, 0xFFE700FF, 0xD2FF00FF, 0xA0FF00FF,
            0x64FF00FF, 0x00FF1EFF, 0x00FF64FF, 0x00FFA0FF, 0x00FFE7FF, 0x00A0FFFF, 0x0064FFFF,
            0x001EFFFF, 0x6400FFFF, 0xA000FFFF, 0xFF00D2FF, 0xFF0064FF, 0xFF3000FF, 0xFF5C00FF,
            0xFF9400FF, 0xFFD200FF, 0xD2FF00FF, 0xA0FF00FF, 0x64FF00FF, 0x1EFF00FF, 0x00FF64FF,
            0x00FFA0FF, 0x00FFD2FF, 0x00A0FFFF, 0x0064FFFF, 0x001EFFFF, 0x5A00FFFF, 0x9400FFFF,
            0xFF00D2FF, 0xFF0094FF, 0xFF0064FF, 0xFF3000FF, 0xFF5C00FF, 0xFF9400FF, 0xFFD200FF,
            0xD2FF00FF, 0xA0FF00FF, 0x64FF00FF,
        ])
    }
    ...
    pub fn palette_pascal_voc_21() -> Vec<Self> {
        Self::create_palette(&[
            ...
            0x800000FF, 0x008000FF, 0x000080FF, 0x808000FF, 0x800080FF, 0x008080FF, 0xC0C0C0FF,
            0xFFA500FF, 0xA52A2AFF, 0x7FFF00FF, 0xDC143CFF, 0x00CED1FF, 0x9400D3FF, 0xFFD700FF,
        ])
    }
