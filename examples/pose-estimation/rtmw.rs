...
pub fn config(args: &RtmwArgs) -> Result<Config> {
    let config = match args.scale {
        Scale::M => Config::rtmw_133_m(),
        Scale::L => Config::rtmw_133_l(),
        Scale::X => Config::rtmw_133_x(),
        _ => anyhow::bail!("Unsupported RTMW scale: {}", args.scale),
    }
