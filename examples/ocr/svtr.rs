...
#[derive(Args, Debug)]
pub struct SvtrArgs {
    /// Variant: ppocr-v3-ch, ppocr-v4-ch, ppocr-v3-en, ppocr-v4-en, ppocr-v4-server-ch, ppocr-v5-mobile, ppocr-v5-server, repsvtr-ch
...
pub fn config(args: &SvtrArgs) -> Result<Config> {
    let config = match args.variant.as_str() {
        ...
        "ppocr-v4-en" => Config::ppocr_rec_v4_en(),
        "ppocr-v4-server-ch" => Config::ppocr_rec_v4_server_ch(),
        "ppocr-v5-mobile" => Config::ppocr_rec_v5_mobile(),
        "ppocr-v5-server" => Config::ppocr_rec_v5_server(),
        "repsvtr-ch" => Config::repsvtr_ch(),
        _ => anyhow::bail!("Unsupported SVTR variant: {}", args.variant),
    }
